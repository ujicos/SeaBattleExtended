...
export const achievements: AchievementDefinition[] = [
  ...
  { id: "repair_kit", title: "Patch Job", description: "Use a Repair Kit treasure.", hidden: true },
  { id: "splash_zone", title: "Splash Zone", description: "Arm a Splash Zone treasure.", hidden: true },
  { id: "decoy_found", title: "Baited", description: "Fire at a decoy treasure.", hidden: true },
  { id: "powder_trail", title: "Powder Trail", description: "Trigger Splash Zone 5 times.", hidden: true },
  { id: "ship_surgeon", title: "Ship Surgeon", description: "Repair 10 ship segments.", hidden: true },
  { id: "bait_collector", title: "Bait Collector", description: "Hit 5 decoys.", hidden: true },
  { id: "last_plank_standing", title: "Last Plank Standing", description: "Win with only a 1-cell ship left.", hidden: true },
  { id: "cold_read", title: "Cold Read", description: "Hit on your first shot.", hidden: true },
  { id: "blind_luck", title: "Blind Luck", description: "Hit during Fog Tide without any prior nearby hits.", hidden: true },
  { id: "storm_dodger", title: "Storm Dodger", description: "Survive 3 storm waves in one match.", hidden: true },
  { id: "no_loose_ends", title: "No Loose Ends", description: "Sink every enemy ship without hitting a disabled buffer zone.", hidden: true },
  { id: "big_game_hunter", title: "Big Game Hunter", description: "Sink the largest ship first.", hidden: true },
  { id: "cleanup_crew", title: "Cleanup Crew", description: "Sink the smallest ship last.", hidden: true },
  { id: "triple_tap", title: "Triple Tap", description: "Land all 3 multi-bomb shots.", hidden: true },
  { id: "full_send", title: "Full Send", description: "Win using a heat-seeking missile.", hidden: true },
  { id: "treasure_run", title: "Treasure Run", description: "Trigger 3 treasures in one match.", hidden: true },
  { id: "false_hope", title: "False Hope", description: "Have an enemy shield block your hit, then still win.", hidden: true },
  { id: "comeback_tide", title: "Comeback Tide", description: "Win after being down 3 ships.", hidden: true },
  { id: "silent_sea", title: "Silent Sea", description: "Win with music and SFX muted.", hidden: true },
  { id: "quick_draw", title: "Quick Draw", description: "Fire within 2 seconds of your turn starting.", hidden: true },
  { id: "patient_captain", title: "Patient Captain", description: "Win a match longer than 100 turns.", hidden: true },
  { id: "perfect_storm", title: "Perfect Storm", description: "Win with Fog Tide and Storm Mode enabled.", hidden: true },
  { id: "chaos_crown", title: "Chaos Crown", description: "Win with Pirate Chaos, Treasure Tiles, and Storm Mode enabled.", hidden: true },
  ...
  { id: "close_call", title: "Close Call", description: "Win with exactly 1 ship left.", hidden: true },
  { id: "treasure_goblin", title: "Treasure Goblin", description: "Trigger 10 treasures total.", hidden: true },
  { id: "fog_sniper", title: "Fog Sniper", description: "Land 5 Fog Tide hits in one match.", hidden: true },
  { id: "storm_rider", title: "Storm Rider", description: "Win after one of your ships gets moved by a storm.", hidden: true },
  { id: "no_mercy", title: "No Mercy", description: "Sink 3 ships in 3 consecutive turns.", hidden: true },
  { id: "denied", title: "Denied", description: "Block a hit with shield treasure.", hidden: true },
  { id: "long_voyage", title: "Long Voyage", description: "Finish a match over 75 turns.", hidden: true },
  { id: "tiny_terror", title: "Tiny Terror", description: "Win with a 1-cell ship still alive.", hidden: true },
