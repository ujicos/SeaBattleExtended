...
export const boardConfigs: BoardConfig[] = [
  { id: "classic-8", label: "GamePigeon Classic 8x8", size: 8, fleet: fleet([4, 3, 3, 2, 2]) },
  { id: "classic-9", label: "GamePigeon Classic 9x9", size: 9, fleet: fleet([5, 4, 3, 3, 2]) },
  { id: "classic-10", label: "GamePigeon Classic 10x10", size: 10, fleet: fleet([5, 4, 3, 3, 2]) },
